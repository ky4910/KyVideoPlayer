...
template <> constexpr inline auto AudioDecoder::qt_create_metaobjectdata<qt_meta_tag_ZN12AudioDecoderE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(AVCodecParameters *)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
...
void AudioDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onAudioCodecParReady((*reinterpret_cast<std::add_pointer_t<AVCodecParameters*>>(_a[1]))); break;
